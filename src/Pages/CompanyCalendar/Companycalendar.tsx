...
function CompanyCalendar() {
  ...
  return (
    <Box className="company-calendar-page">
      <Box className="company-calendar-header">
        <Box className="company-calendar-header-icon">
          <CalendarMonthOutlinedIcon className="company-calendar-header-icon-svg" />
        </Box>
        <Box className="company-calendar-header-content">
          <Typography className="company-calendar-title">Company Calendar</Typography>
          <Typography className="company-calendar-subtitle">
      ...
      {loadError && (
        <Typography className="company-calendar-error">{loadError}</Typography>
      )}
        ...
        <Box className="company-calendar-side-panel">
          <Box className="company-calendar-side-header">
            ...
            {isSameDay(selectedDate, today) && (
              <Chip label="Today" size="small" className="company-calendar-today-chip" />
            )}
          </Box>
            ...
            {selectedHolidays.length === 0 ? (
              ...
              <Box className="company-calendar-holiday-list">
                {selectedHolidays.map((holiday) => (
                  <Box key={holiday._id} className="company-calendar-holiday-item">
